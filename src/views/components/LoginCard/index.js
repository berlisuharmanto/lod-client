                    ...
                    <form className="mb-4" onSubmit={(e) => handleSubmit(e)}>
                        <div className="mb-4">
                            ...
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="email" type="text" placeholder="Ex: berli.suharmanto88@gmail.com" onChange={handleEmailChange}/>
                        </div>
                        <div className="mb-6">
                            ...
                            <input className="shadow appearance-none border border rounded w-full py-2 px-3 text-gray-700 mb-3
                                leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" onChange={handlePasswordChange}
                                placeholder="******************" />
                        </div>
                        ...
                        <div className="flex items-center justify-center m-2">
                            <a href='/register' className='text-blue-700 hover:text-blue-500'>Register</a>
                        </div>
                    </form>
                    {errorMessage && (
